...
(function (factory, window) {
    ...
    L.Control.Locate = L.Control.extend({
        options: {
            ...
            icon: 'fa fa-crosshairs',  // fa-location-arrow or fa-map-marker
        ...
        _setClasses: function(state) {
            if (state == 'requesting') {
                L.DomUtil.removeClasses(this._container, "mapactive following");
            ...
            } else if (state == 'mapactive') {
                L.DomUtil.removeClasses(this._container, "requesting following");
                L.DomUtil.addClasses(this._container, "mapactive");
                ...
                L.DomUtil.addClasses(this._container, "mapactive following");
        ...
        _cleanClasses: function() {
            ...
            L.DomUtil.removeClass(this._container, "mapactive");
