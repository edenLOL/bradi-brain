L.Control.Sidebar = L.Control.extend({
    ...
    open: function(id) {
        ...
        for (i = this._panes.length - 1; i >= 0; i--) {
            child = this._panes[i];
            if (child.id == id)
                L.DomUtil.addClass(child, 'mapactive');
            else if (L.DomUtil.hasClass(child, 'mapactive'))
                L.DomUtil.removeClass(child, 'mapactive');
        }
        ...
        if (L.DomUtil.hasClass(this._sidebar, 'collapsed')) {
            ...
            $('.leaflet-left').animate({'left': leftpadding}, 300)
    ...
    close: function() {
        ...
        for (var i = this._tabitems.length - 1; i >= 0; i--) {
            ...
            if (L.DomUtil.hasClass(child, 'mapactive'))
                L.DomUtil.removeClass(child, 'mapactive');
        }
        ...
        if (!L.DomUtil.hasClass(this._sidebar, 'collapsed')) {
            this.fire('closing');
            $('.leaflet-left').animate({'left': '50px'}, 500)            
     ...
     */
    _onClick: function() {
        if (L.DomUtil.hasClass(this, 'mapactive'))
            this._sidebar.close();
